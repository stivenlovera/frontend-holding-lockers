...
export class InventoryListComponent implements OnInit, AfterViewInit, OnDestroy {
    ...
    ngAfterViewInit(): void {
        console.log(this._paginator.pageIndex, this._paginator.pageSize, this._sort.active, this._sort.direction)
        ...
        if (this._sort && this._paginator) {
            ...
            merge(this._sort.sortChange, this._paginator.page).pipe(
                switchMap(() => {
                    console.log('detect merge para paginar')
                    this.closeDetails();
                    this.isLoading = true;

                    const data = this._inventoryService.getProducts(this._paginator.pageIndex, this._paginator.pageSize, this._sort.active, this._sort.direction);
                    data.subscribe((res) => {
                        console.log(res)
                    })
                    return data
